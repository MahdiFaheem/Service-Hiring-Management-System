                                    ...
                                    <div class="tab-pane fade show active" id="basicInfo" role="tabpanel" aria-labelledby="basicInfo-tab">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 col-6"> 
                                               Sender id: <input type="text" name="sender" value="{{$message->senderid}}" > 
                                               {{$errors->first('sender')}}
                                               <br> <br>
                                               Message :<input type="text" name="message" value="{{$message->message}}" >
                                               {{$errors->first('message')}}
                                               <br> <br>
                                             Reply  :  &nbsp &nbsp  <input type="text" name="reply" value="" >
                                             {{$errors->first('reply')}}
                                            </div>
                                        </div>
                                        <hr />
