    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item"><a href="/customer/message" class="nav-link">Message</a></li>
      ...
      <div class="row no-gutters slider-text justify-content-center align-items-center">
        <div class="col-lg-8 col-md-6 ftco-animate d-flex align-items-end">
          <div class="text text-center">
            <h1 class="mb-4">The Simplest <br>Way to Find Services</h1>
            <p style="font-size: 18px;">Choose your desired services from our reliable service providers.
              Book your appointments from anywhere in Bangladesh.</p>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-md-12 heading-section text-center ftco-animate mb-5">
          ...
          <h2 class="mb-2">The smartest way to book service appointments</h2>
        </div>
      </div>
