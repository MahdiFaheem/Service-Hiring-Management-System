                                ...
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            Service id
                                            <input type="text" class="form-control" placeholder="" value="{{$service->serviceid}}" name="serviceid"  />
                                    ...
                                    <div class="col-md-6">
                                            <div class="form-group">
                                                Price(in Tk)
                                                 <input type="text" class="form-control" placeholder="" value="{{$service->price}}" name="price"  />
                                                 {{$errors->first('price')}}
                                                </div>
                                        <div class="form-group">
                                            <input type="time" class="form-control" placeholder="Your appointment time *" name="time"  />
                                            {{$errors->first('time')}}
                                        </div>
                                        ...
                                        <input type="submit" class="btnRegister" formaction="../request-appointment/{{$service->userid}}" value="Request"/>
