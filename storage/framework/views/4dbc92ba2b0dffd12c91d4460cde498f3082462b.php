      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-12 heading-section text-center ftco-animate mb-5">
            ...
            <h2 class="mb-2">Your Service Provider List </h2>
          </div>
        </div>
      </div>
...
$(document).ready(function(){
 ...
 $('#search').keyup(function(){ 
        ...
        if(query != '')
        {
         ...
         $.ajax({
          url:"<?php echo e(route('servicepro.search')); ?>",
          method:"POST",
...
</script><?php /**PATH D:\documents\semester 8\ATP3\project\resources\views/admin/serviceprovider.blade.php ENDPATH**/ ?>